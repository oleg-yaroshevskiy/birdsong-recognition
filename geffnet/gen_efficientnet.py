...
model_urls = {
    ...
    "efficientnet_b3": "https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/efficientnet_b3_ra-a5e2fbc7.pth",
...
def tf_efficientnet_b3_ns(config, pretrained=False, **kwargs):
